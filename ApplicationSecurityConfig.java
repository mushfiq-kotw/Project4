...
public class ApplicationSecurityConfig {
	...
	{	http.authorizeHttpRequests((authz)->authz
		.requestMatchers("/ProductOrder/PlaceOrder").hasRole("USER")
		.requestMatchers("/ProductOrder/fetchAllProductOrders").hasRole("USER")
		.requestMatchers("/ProductOrder/fetchByOrderId").hasRole("USER")
		.requestMatchers("/ProductOrder/Update").hasRole("USER")
